...
[CtUnresolvedImport]import static oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains;
...
[CtUnresolvedImport]import io.kubernetes.client.openapi.models.V1SecretReference;
...
public class JobHelperTest {
    [CtFieldImpl]private static final [CtTypeReferenceImpl]java.lang.String NS = [CtLiteralImpl]"ns1";

    [CtFieldImpl]private static final [CtTypeReferenceImpl]java.lang.String DOMAIN_UID = [CtLiteralImpl]"JobHelperTestDomain";
    ...
    [CtFieldImpl]private static final [CtTypeReferenceImpl]java.lang.String OSEV = [CtLiteralImpl]"OPERATOR_SUPPLIED_ENV_VARS";

    [CtFieldImpl]private [CtTypeReferenceImpl]java.lang.reflect.Method getDomainSpec;

    [CtFieldImpl]private final [CtTypeReferenceImpl]oracle.kubernetes.operator.helpers.DomainPresenceInfo domainPresenceInfo = [CtInvocationImpl]createDomainPresenceInfo();
    ...
    public [CtTypeReferenceImpl]void whenDomainHasEnvironmentItems_introspectorPodStartupWithThem() [CtBlockImpl]{
        ...
        [CtInvocationImpl]assertThat([CtInvocationImpl]getMatchingContainerEnv([CtFieldReadImpl]domainPresenceInfo, [CtVariableReadImpl]jobSpec), [CtInvocationImpl]Matchers.allOf([CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"item1"), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"item2"), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"WL_HOME"), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"MW_HOME")));
    }
    ...
    public [CtTypeReferenceImpl]void whenDomainHasEmptyStringUser_Mem_Args_EnvironmentItem_introspectorPodStartupWithIt() [CtBlockImpl]{
        ...
        [CtInvocationImpl]assertThat([CtInvocationImpl]getMatchingContainerEnv([CtFieldReadImpl]domainPresenceInfo, [CtVariableReadImpl]jobSpec), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"USER_MEM_ARGS"));
    }
    ...
    public [CtTypeReferenceImpl]void whenDomainHasEnvironmentItemsWithVariables_introspectorPodStartupWithThem() [CtBlockImpl]{
        ...
        [CtInvocationImpl]assertThat([CtInvocationImpl]getMatchingContainerEnv([CtFieldReadImpl]domainPresenceInfo, [CtVariableReadImpl]jobSpec), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"item1"));
    }
    ...
    public [CtTypeReferenceImpl]void whenDomainHasEnvironmentVars_introspectorPodStartupVerifyDataHomeEnvNotDefined() [CtBlockImpl]{
        ...
        [CtInvocationImpl]assertThat([CtInvocationImpl]getMatchingContainerEnv([CtFieldReadImpl]domainPresenceInfo, [CtVariableReadImpl]jobSpec), [CtInvocationImpl]Matchers.not([CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtTypeAccessImpl]ServerEnvVars.DATA_HOME)));
    }

    [CtFieldImpl]private static final [CtTypeReferenceImpl]java.lang.String OVERRIDE_DATA_DIR = [CtLiteralImpl]"/u01/data";

    [CtFieldImpl]private static final [CtTypeReferenceImpl]java.lang.String OVERRIDE_DATA_HOME = [CtBinaryOperatorImpl][CtBinaryOperatorImpl]([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OVERRIDE_DATA_DIR + [CtFieldReadImpl][CtTypeAccessImpl]java.io.File.[CtFieldReferenceImpl]separator) + [CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.DOMAIN_UID;
    ...
    public [CtTypeReferenceImpl]void whenDomainHasEnvironmentVars_introspectorPodStartupVerifyDataHomeEnvDefined() [CtBlockImpl]{
        ...
        [CtInvocationImpl]assertThat([CtInvocationImpl]getMatchingContainerEnv([CtFieldReadImpl]domainPresenceInfo, [CtVariableReadImpl]jobSpec), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtTypeAccessImpl]ServerEnvVars.DATA_HOME));
    }
    ...
    public [CtTypeReferenceImpl]void whenAdminServerHasEnvironmentItems_introspectorPodStartupWithThem() [CtBlockImpl]{
        ...
        [CtInvocationImpl]assertThat([CtInvocationImpl]getMatchingContainerEnv([CtFieldReadImpl]domainPresenceInfo, [CtVariableReadImpl]jobSpec), [CtInvocationImpl]Matchers.allOf([CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"item1"), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"item2"), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"item3")));
    }
    ...
    public [CtTypeReferenceImpl]void whenDomainHasValueFromEnvironmentItems_introspectorPodStartupWithThem() [CtBlockImpl]{
        ...
        [CtInvocationImpl]assertThat([CtInvocationImpl]getMatchingContainerEnv([CtFieldReadImpl]domainPresenceInfo, [CtVariableReadImpl]jobSpec), [CtInvocationImpl]Matchers.allOf([CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtInvocationImpl][CtFieldReadImpl]configMapKeyRefEnvVar.getName()), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtInvocationImpl][CtFieldReadImpl]secretKeyRefEnvVar.getName()), [CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtInvocationImpl][CtFieldReadImpl]fieldRefEnvVar.getName())));
    }
    ...
    public [CtTypeReferenceImpl]void introspectorPodStartupWithNullAdminUsernamePasswordEnvVarValues() [CtBlockImpl]{
        ...
        [CtInvocationImpl]assertThat([CtInvocationImpl]getMatchingContainerEnv([CtFieldReadImpl]domainPresenceInfo, [CtVariableReadImpl]jobSpec), [CtInvocationImpl]Matchers.allOf([CtInvocationImpl]Matchers.not([CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"ADMIN_USERNAME")), [CtInvocationImpl]Matchers.not([CtInvocationImpl]oracle.kubernetes.operator.helpers.Matchers.hasEnvVarContains([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.OSEV, [CtLiteralImpl]"ADMIN_PASSWORD"))));
    }
    ...
    public [CtTypeReferenceImpl]void podTemplate_hasDomainUidLabel() [CtBlockImpl]{
        [CtLocalVariableImpl][CtTypeReferenceImpl]io.kubernetes.client.openapi.models.V1JobSpec jobSpec = [CtInvocationImpl]createJobSpec();
        [CtInvocationImpl]assertThat([CtInvocationImpl]getTemplateLabel([CtVariableReadImpl]jobSpec, [CtTypeAccessImpl]LabelConstants.DOMAINUID_LABEL), [CtInvocationImpl]CoreMatchers.equalTo([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.DOMAIN_UID));
    }

    [CtMethodImpl][CtAnnotationImpl]@org.junit.Test
    public [CtTypeReferenceImpl]void podTemplate_hasJobNameLabel() [CtBlockImpl]{
        [CtLocalVariableImpl][CtTypeReferenceImpl]io.kubernetes.client.openapi.models.V1JobSpec jobSpec = [CtInvocationImpl]createJobSpec();
        [CtInvocationImpl]assertThat([CtInvocationImpl]getTemplateLabel([CtVariableReadImpl]jobSpec, [CtTypeAccessImpl]LabelConstants.JOBNAME_LABEL), [CtInvocationImpl]CoreMatchers.equalTo([CtInvocationImpl][CtTypeAccessImpl]oracle.kubernetes.operator.helpers.LegalNames.toJobIntrospectorName([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.DOMAIN_UID)));
    }
    ...
    [CtMethodImpl]private [CtTypeReferenceImpl]oracle.kubernetes.operator.helpers.DomainPresenceInfo createDomainPresenceInfo() [CtBlockImpl]{
        [CtLocalVariableImpl][CtTypeReferenceImpl]oracle.kubernetes.operator.helpers.DomainPresenceInfo domainPresenceInfo = [CtConstructorCallImpl]new [CtTypeReferenceImpl]oracle.kubernetes.operator.helpers.DomainPresenceInfo([CtInvocationImpl][CtInvocationImpl][CtConstructorCallImpl]new [CtTypeReferenceImpl]oracle.kubernetes.weblogic.domain.model.Domain().withMetadata([CtInvocationImpl][CtConstructorCallImpl]new [CtTypeReferenceImpl]io.kubernetes.client.openapi.models.V1ObjectMeta().namespace([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.NS)).withSpec([CtInvocationImpl][CtInvocationImpl][CtConstructorCallImpl]new [CtTypeReferenceImpl]oracle.kubernetes.weblogic.domain.model.DomainSpec().withDomainUid([CtFieldReadImpl]oracle.kubernetes.operator.helpers.JobHelperTest.DOMAIN_UID).withWebLogicCredentialsSecret([CtInvocationImpl][CtConstructorCallImpl]new [CtTypeReferenceImpl]io.kubernetes.client.openapi.models.V1SecretReference().name([CtLiteralImpl]"webLogicCredentialsSecretName"))));
